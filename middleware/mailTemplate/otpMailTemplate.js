const otpMailTemplate = (otp, productName = "AiNextro LMS") => {
  const brand = productName || "AiNextro LMS";
  return `
    <!DOCTYPE html>
    <html lang="en">
    <head>
      ...
      <title>OTP Verification - ${brand}</title>
      <style>
        body {
    ...
    <body>
      <div class="container">
        ...
        <div class="footer">
          <p>© ${brand}. Admin login verification.</p>
        </div>
      </div>
    </body>
    </html>
