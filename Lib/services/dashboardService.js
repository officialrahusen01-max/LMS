  ...
  static async getInstructorStats(instructorId) {
    try {
      const [
        ...
        this.getInstructorEnrollments(instructorId),
        this.getInstructorCertificates(instructorId),
        this.getInstructorBlogStats(instructorId),
      ]);
  ...
  static async getStudentStats(userId) {
    try {
      const [
        ...
        this.getStudentEnrollments(userId),
        this.getStudentProgress(userId),
        this.getStudentCertificates(userId),
        this.getRecommendedCourses(userId),
        this.getStudentRecentActivity(userId),
      ]);
